---
title: "苹果终端草"
description: "Apple Terminal Grass 配置文件具有黑色背景和亮绿色文本，每个字符都有打字动画。"
---

# 苹果终端草

内置 Grass 配置文件中的 macOS Terminal.app 窗口 — 漆黑的背景，纯绿色的文本和匹配的光标。经典的终端美学与每个字符的打字动画。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-grass.html` | `compositions/code-snippet-apple-terminal-grass.html` | 超框架:组合 |
...
- 忠实再现 macOS Terminal.app Grass 配置文件 — 黑色背景，#00C100 绿色文本
- 带有绿色标题栏和交通灯按钮的 macOS 窗口镀铬
