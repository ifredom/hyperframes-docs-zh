---
title: "苹果码头海洋"
description: "Apple Terminal Ocean 配置文件具有深蓝色背景和白色文本，每个字符都有打字动画。"
---

# 苹果码头海洋

内置 Ocean 配置文件中的 macOS Terminal.app 窗口 — 生动的 `#224FBE` 蓝色背景和清晰的白色文本。大胆而独特，带有每个字符的打字动画。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-ocean.html` | `compositions/code-snippet-apple-terminal-ocean.html` | 超框架:组合 |
...
- 忠实再现 macOS Terminal.app Ocean 配置文件 — #224FBE 蓝色背景，白色文本
