---
title: "光2026"
description: "最新的 VS Code 浅色主题具有精致的令牌范围和更新的调色板。"
---

# 光2026

VS Code 工作台，在 Light 2026 主题中具有每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-light-2026.html` | `compositions/code-snippet-light-2026.html` | 超框架:组合 |
