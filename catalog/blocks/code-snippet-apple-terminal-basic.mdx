---
title: "苹果终端基本"
description: "Apple 终端基本配置文件，白色背景和黑色文本，每个字符的打字动画。"
---

# 苹果终端基本

内置基本配置文件中的 macOS Terminal.app 窗口 — 干净的白色背景，带有黑色等宽文本和纯黑色光标。每个字符的打字动画与输出显示。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-basic.html` | `compositions/code-snippet-apple-terminal-basic.html` | 超框架:组合 |
...
- 忠实再现 macOS Terminal.app 基本配置文件 — 白色背景、黑色文本、实心光标
- 带有交通灯按钮（关闭、最小化、全屏）和居中标题栏的 macOS 窗口镶边
