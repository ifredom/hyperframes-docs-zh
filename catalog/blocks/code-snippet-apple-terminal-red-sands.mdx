---
title: "苹果终端红沙"
description: "Apple 终端 Red Sands 配置文件具有深红色背景和沙色文本，每个字符都有打字动画。"
---

# 苹果终端红沙

内置 Red Sands 配置文件中的 macOS Terminal.app 窗口 — 深红色 `#7B140E` 背景和温暖的沙色 `#FFE1B9` 文本。大胆、戏剧性的外观以及每个字符的打字动画。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-red-sands.html` | `compositions/code-snippet-apple-terminal-red-sands.html` | 超框架:组合 |
