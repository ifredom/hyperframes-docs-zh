---
title: "深色+"
description: "经典的深色主题，具有针对流行语言的增强语法突出显示。"
---

# 深色+

VS Code 工作台在 Dark+ 主题中具有每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-dark-plus.html` | `compositions/code-snippet-dark-plus.html` | 超框架:组合 |
