---
title: "轻现代"
description: "默认灯光主题 — 经典 VS 灯光体验的清新、现代演绎。"
---

# 轻现代

VS Code 工作台，在 Light Modern 主题中具有每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-light-modern.html` | `compositions/code-snippet-light-modern.html` | 超框架:组合 |
