---
title: "视觉工作室灯光"
description: "传统的 Visual Studio 浅色方案。"
---

# 视觉工作室灯光

VS Code 工作台，在 Visual Studio Light 主题中提供每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-visual-studio-light.html` | `compositions/code-snippet-visual-studio-light.html` | 超框架:组合 |
