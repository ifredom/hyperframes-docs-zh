---
title: "Visual Studio 黑暗"
description: "传统的 Visual Studio 深色配色方案。"
---

# Visual Studio 黑暗

VS Code 工作台，在 Visual Studio Dark 主题中提供每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-visual-studio-dark.html` | `compositions/code-snippet-visual-studio-dark.html` | 超框架:组合 |
