---
title: "苹果终端 透明 深色"
description: "Apple Terminal Clear Dark 配置文件具有半透明深色背景和白色文本、每个字符的打字动画。"
---

# 苹果终端 透明 深色

内置 Clear Dark 配置文件中的 macOS Terminal.app 窗口 — 半透明黑色背景，带有白色文本和灰色光标。每个字符的打字动画与输出显示。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-clear-dark.html` | `compositions/code-snippet-apple-terminal-clear-dark.html` | 超框架:组合 |
...
- 忠实再现 macOS Terminal.app Clear Dark 配置文件 — 半透明黑色背景和白色文本
