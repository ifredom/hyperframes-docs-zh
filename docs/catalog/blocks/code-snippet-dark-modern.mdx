---
title: "黑暗现代"
description: "默认的深色主题——干净、现代，对比度舒适。"
---

# 黑暗现代

VS Code 工作台，在 Dark Modern 主题中具有每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-dark-modern.html` | `compositions/code-snippet-dark-modern.html` | 超框架:组合 |
