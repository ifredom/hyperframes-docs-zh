---
title: "日光照射"
description: "Ethan Schoonover 精心设计的浅色方案。"
---

# 日光照射

VS Code 工作台，在 Solarized Light 主题中提供每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-solarized-light.html` | `compositions/code-snippet-solarized-light.html` | 超框架:组合 |
