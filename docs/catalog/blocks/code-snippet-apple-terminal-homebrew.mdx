---
title: "苹果终端自制程序"
description: "Apple Terminal Homebrew 配置文件具有黑色背景、亮绿色文本和石灰光标、每个字符的打字动画。"
---

# 苹果终端自制程序

内置 Homebrew 配置文件中的 macOS Terminal.app 窗口 — 黑色背景，带有鲜艳的绿色文本和石灰 `#48F800` 光标。最受欢迎的经典终端外观之一。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-apple-terminal-homebrew.html` | `compositions/code-snippet-apple-terminal-homebrew.html` | 超框架:组合 |
...
- 忠实再现 macOS Terminal.app Homebrew 配置文件 — 黑色背景，带有 #00CF00 文本和 #48F800 光标
