---
title: "高对比度"
description: "最大对比度深色主题以实现可访问性。"
---

# 高对比度

VS Code 工作台在高对比度主题中具有每个字符的打字动画。完整的编辑器镶边，带有活动栏、侧边栏、选项卡、终端和状态栏。
...
| 文件 | 目标 | 类型 |
| --- | --- | --- |
| `code-snippet-high-contrast.html` | `compositions/code-snippet-high-contrast.html` | 超框架:组合 |
